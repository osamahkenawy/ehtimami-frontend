                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <div class="text-center dark:text-white">
                            ...
                            <router-link to="/auth/cover-login" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">
                                SIGN IN
                            </router-link>
                        </div>
                    </div>
                    <p class="absolute bottom-6 w-full text-center dark:text-white">© {{ new Date().getFullYear() }}.Ehtimami All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
