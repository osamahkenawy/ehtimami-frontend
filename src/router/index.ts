...
const routes: RouteRecordRaw[] = [
    ...
    // Classes
    {
        ...
        name: 'classes',
        component: () => import(/* webpackChunkName: "apps-chat" */ '../views/ehtimami/classes/index.vue'),
    },
    {
        path: '/ehtimami/classes/add', 
        name: 'add-class',
        component: () => import(/* webpackChunkName: "apps-chat" */ '../views/ehtimami/classes/components/add.vue'),
    },
    {
        path: '/ehtimami/teachers', 
        name: 'teachers',
        component: () => import(/* webpackChunkName: "apps-chat" */ '../views/ehtimami/teachers/index.vue'),
    },
    {
        path: '/ehtimami/teachers/add', 
        name: 'add-teacher',
        component: () => import(/* webpackChunkName: "apps-chat" */ '../views/ehtimami/teachers/components/add.vue'),
    },
    {
    ...
    
    {
        path: '/ehtimami/user', 
        name: 'user',
        component: () => import(/* webpackChunkName: "apps-chat" */ '@/views/ehtimami/users/index.vue'),
    },
    {
        path: '/ehtimami/user/profile/:id', 
        name: 'user-profile',
        component: () => import(/* webpackChunkName: "apps-chat" */ '@/views/ehtimami/users/components/Profile/index.vue'),
    },
    {
